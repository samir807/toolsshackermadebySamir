...
....##.....#######...#######..########..######...######.
========================================
Created By SamirHacker
Ver: 1.0
----
ДЛЯ ТЕРМУКСА!
----
==========================================
00. Запустить на своем Андроиде Хакерскую машину.
------------------------------------------
1. Скачать Nmap 
2. Скачать Hydra
3. Скачать SQLMap
...
13. Скачать Twitter Bruteforcer   (TwitterSniper)
14. Скачать Ubuntu
15. Скачать Fedora
16. Скачать viSQL
...
while loop:
    ...
    if what == "00":
        print("================================")
        print("Вы можете установить: nmap, hydra, sqlmap, metasploit, ngrok, angryFuzzer, red_hawk, weeman, IPGeoLocation, cupp, instahack, TwitterSniper, Hash-Buster, D-TECT, routersploit и viSQL в один клик.")
        print("----------------")
        hm = input("[?] Вы хотите продолжить? (y/n): ")
        print("================================")
        if hm == "y":
            print("========================================================")
            print("[+] Пожалуйста, положите свой Андроид и идите в туалет...")
            print("Вам нужно много ждать.")
            print("========================================================")
    ...
    if what == "1":
        ...
        print("[+] Введите 'nmap' чтобы начать.")
        print("====================================")
        rmenu = input("[?] Назад в меню? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        os.system("cd /data/data/com.termux/files/home")
        print("====================================")
        print("[+] hydra успешно установлен :)")
        ...
        print("[+] Перейдите в директорию с sqlmap и введите 'python2 sqlmap.py' чтобы начать.")
        print("====================================")
        rmenu = input("[?] Назад в меню? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        print("[+] Перейдите в директорию с ngrok и введите './ngrok http 80' чтобы начать.")
        print("====================================")
        rmenu = input("[?] Назад в меню? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        os.system("cd /data/data/com.termux/files/home")
        print("====================================")
        print("[+] Nethunter успешно установлен :)")
        print("[+] Перейдите в директорию с Nethunter-In-Termux и введите './kalinethunter' чтобы начать.")
        print("====================================")
        rmenu = input("[?] Назад в меню? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        print("[+] Перейдите в директорию с angryFuzzer и введите 'python2 angryFuzzer.py' чтобы начать.")
        print("====================================")
        rmenu = input("[?] Назад в меню? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        print("[+] Перейдите в директорию с RED_HAWK и введите 'php rhawk.php' чтобы начать.")
        print("====================================")
        rmenu = input("[?] Назад в меню? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        print("[+] Перейдите в директорию с weeman и введите 'python2 weeman.py' чтобы начать.")
        print("====================================")
        rmenu = input("[?] Назад в меню? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        print("[+] Перейдите в директорию с IPGeoLocation и введите 'python ipgeolocation.py' чтобы начать.")
        print("====================================")
        rmenu = input("[?] Назад в меню? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        print("[+] Перейдите в директорию с cupp и введите 'python cupp3.py' чтобы начать.")
        print("====================================")
        rmenu = input("[?] Назад в меню? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        print("[+] Перейдите в директорию с instahack и введите 'python hackinsta.py' чтобы начать.")
        print("====================================")
        rmenu = input("[?] Назад в меню? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        print("[+] Перейдите в директорию с TwitterSniper и введите 'python TwitterSniper.py' чтобы начать.")
        print("====================================")
        rmenu = input("[?] Назад в меню? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        print("[+] Перейдите в директорию с Ubuntu и введите './start.sh' чтобы начать.")
        print("====================================")
        rmenu = input("[?] Назад в меню? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        print("[+] Перейдите в директорию с 'sh termux-fedora.sh f26_arm64' или 'sh termux-fedora.sh f26_arm' чтобы начать.")
        print("====================================")
        rmenu = input("[?] Назад в меню? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        print("[+] Перейдите в директорию с viSQL и введите 'python2 viSQL.py --help' чтобы начать.")
        print("====================================")
        rmenu = input("[?] Назад в меню? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        print("[+] Перейдите в директорию Hash-Buster и введите 'python2 hash.py' чтобы начать.")
        print("====================================")
        rmenu = input("[?] Назад в меню? (y/n): ")
        if rmenu == "y":
            menu()
        ...
        print("====================================")
        print("[+] Hash-Buster успешно установлен :)")
        print("[+] Перейдите в директорию с Hash-Buster и введите 'python2 hash.py' чтобы начать.")
        print("====================================")
        rmenu = input("[?] Назад в меню? (y/n): ")
        if rmenu == "y":
            menu()
            ...
            print("[+] Перейдите в директорию с routersploit и введите 'python2 rsf.py' чтобы начать.")
            print("====================================")
            rmenu = input("[?] Назад в меню? (y/n): ")
            if rmenu == "y":
                menu()
